...
var agentRegistry = map[string]AgentConfig{
	...
	"devin": {
		...
		GlobalDetectDirs: func() []string { return []string{filepath.Join(xdgConfigHome(), "devin")} },
		GlobalSkillsDir:  func() string { return filepath.Join(xdgConfigHome(), "devin", "skills") },
	},
	"goose": {
	...
	"dexto":       homeAgentCustomGlobal("dexto", "Dexto", ".agents/skills", ".dexto", func() string { return filepath.Join(homeDir(), ".agents", "skills") }),
	...
	// Global path is .tabnine/agent/skills, not .tabnine/skills — does not fit homeAgent helper.
	"tabnine-cli": homeAgentCustomGlobal("tabnine-cli", "Tabnine CLI", ".tabnine/agent/skills", ".tabnine", func() string { return filepath.Join(homeDir(), ".tabnine", "agent", "skills") }),
	...
	"aider-desk": homeAgent("aider-desk", "AiderDesk", ".aider-desk/skills", ".aider-desk"),
	"augment":    homeAgent("augment", "Augment", ".augment/skills", ".augment"),
	"bob":        homeAgent("bob", "IBM Bob", ".bob/skills", ".bob"),
	// Agent name "codearts-agent" intentionally differs from the on-disk dotDir ".codeartsdoer".
	"codearts-agent": homeAgent("codearts-agent", "CodeArts Agent", ".codeartsdoer/skills", ".codeartsdoer"),
	"codebuddy":      homeAgent("codebuddy", "CodeBuddy", ".codebuddy/skills", ".codebuddy"),
	"codemaker":      homeAgent("codemaker", "Codemaker", ".codemaker/skills", ".codemaker"),
	"codestudio":     homeAgent("codestudio", "Code Studio", ".codestudio/skills", ".codestudio"),
	...
	"forgecode":      homeAgent("forgecode", "ForgeCode", ".forge/skills", ".forge"),
	...
	"hermes-agent":   homeAgent("hermes-agent", "Hermes Agent", ".hermes/skills", ".hermes"),
	...
	"rovodev":        homeAgent("rovodev", "Rovo Dev", ".rovodev/skills", ".rovodev"),
